...
class DashBoardChangeFacture(tk.Frame):
    '''
    Classe qui crée le tableau de bord pour le changement de facture
    '''
    def __init__(self, master=None, numero_facture=None):
        '''
        Constructeur de la classe DashBoardChangeFacture
        '''
        ...
        self.facture_to_change = Dao_facture.get(self.numero_facture)
        ...
        self.entry_nom_facture.insert(0, self.facture_to_change[0][1])
        self.entry_nom_facture.config(state='readonly')
        ...
        self.entry_nom_entreprise.insert(0, self.facture_to_change[0][2])
        ...
        self.entry_email_entreprise.insert(0, self.facture_to_change[0][3])
        ...
        self.entry_adresse_entreprise.insert(0, self.facture_to_change[0][4])
        ...
        self.entry_telephone_entreprise.insert(0, self.facture_to_change[0][5])
        ...
        self.entry_nom_client.insert(0, self.facture_to_change[0][6])
        ...
        self.entry_email_client.insert(0, self.facture_to_change[0][7])
        ...
        self.entry_adresse_client.insert(0, self.facture_to_change[0][8])
        ...
        self.entry_telephone_client.insert(0, self.facture_to_change[0][9])
        ...
        self.entry_numero_facture.insert(0, self.facture_to_change[0][10])
        self.entry_numero_facture.config(state='readonly')
        ...
        self.entry_date.insert(0, self.facture_to_change[0][11])
        ...
        self.entry_conditions.insert(0, self.facture_to_change[0][12])
        ...
        self.sous_total.set(self.facture_to_change[0][17])
        ...
        self.tva.set(self.facture_to_change[0][18])
        ...
        self.total.set(self.facture_to_change[0][19])
        ...
        self.solde_du.set(self.facture_to_change[0][20])
