...
class DashBoardCreateDevis(tk.Frame):
    def __init__(self, master=None, client_to_search=None):
        '''
        Constructeur de la classe DashBoardCreateDevis
        '''
        ...
        self.entry_nom_devis.insert(0, 'Devis')
        ...
        self.entry_numero_devis.insert(0, "DEV{}".format(Dao_devis.get_next_id()))
